...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "pdc03_module05_exercise01.Android.dll" comes first in this list. */
		"pdc03_module05_exercise01.Android.dll",
		"FormsViewGroup.dll",
		"pdc03_module05_exercise01.dll",
